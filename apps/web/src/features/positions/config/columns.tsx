...
import { ScreenshotThumbnail } from '../components/ScreenshotGallery';
    ...
    return [
      ...
      },
      {
        ...
        cell: (trade: Trade) => {
          ...
          return (
            <span
              className={`block text-center px-2 py-1 rounded-full text-xs font-medium ${getCategoryColorClass(categoryName, categoryId, defaultCategoryId)}`}
            >
              {categoryName}
            </span>
          );
