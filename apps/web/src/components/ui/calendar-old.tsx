    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          'size-8 p-0 font-normal aria-selected:opacity-100 text-foreground dark:hover:text-primary-foreground',
        ),
        day_range_start:
        ...
        day_today: 'bg-accent text-accent-foreground dark:text-accent-foreground',
        day_outside:
