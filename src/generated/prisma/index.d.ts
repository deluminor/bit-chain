...
export namespace Prisma {
  ...
  */
   ...
   * BudgetCountOutputType without action
   */
  export type BudgetCountOutputTypeCountChildBudgetsArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    where?: BudgetWhereInput;
  };
  ...
  interface TransactionFieldRefs {
    ...
    readonly transferAmount: FieldRef<'Transaction', 'Float'>;
    readonly transferCurrency: FieldRef<'Transaction', 'String'>;
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    user<T extends UserDefaultArgs<ExtArgs> = {}>(
      ...
      GlobalOmitOptions
    >;
    parentTemplate<T extends Budget$parentTemplateArgs<ExtArgs> = {}>(
      args?: Subset<T, Budget$parentTemplateArgs<ExtArgs>>,
    ): Prisma__BudgetClient<
      $Result.GetResult<
      ...
      GlobalOmitOptions
    >;
    childBudgets<T extends Budget$childBudgetsArgs<ExtArgs> = {}>(
      args?: Subset<T, Budget$childBudgetsArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      $Result.GetResult<Prisma.$BudgetPayload<ExtArgs>, T, 'findMany', GlobalOmitOptions> | Null
    >;
   ...
   */
  export type Budget$parentTemplateArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Budget
   ...
   * Budget.childBudgets
   */
  export type Budget$childBudgetsArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Budget
  ...
  export type TransactionWhereInput = {
    ...
    transferAmount?: FloatNullableFilter<'Transaction'> | number | null;
    transferCurrency?: StringNullableFilter<'Transaction'> | string | null;
  ...
  export type TransactionOrderByWithRelationInput = {
    ...
    transferCurrency?: SortOrderInput | SortOrder;
  ...
  export type TransactionScalarWhereWithAggregatesInput = {
    ...
    transferAmount?: FloatNullableWithAggregatesFilter<'Transaction'> | number | null;
    transferCurrency?: StringNullableWithAggregatesFilter<'Transaction'> | string | null;
  ...
  export type BudgetCreateNestedOneWithoutChildBudgetsInput = {
    create?: XOR<
      BudgetCreateWithoutChildBudgetsInput,
      BudgetUncheckedCreateWithoutChildBudgetsInput
    >;
  ...
  export type BudgetCreateNestedManyWithoutParentTemplateInput = {
    create?:
      | XOR<BudgetCreateWithoutParentTemplateInput, BudgetUncheckedCreateWithoutParentTemplateInput>
      | BudgetCreateWithoutParentTemplateInput[]
      | BudgetUncheckedCreateWithoutParentTemplateInput[];
    connectOrCreate?:
      | BudgetCreateOrConnectWithoutParentTemplateInput
      | BudgetCreateOrConnectWithoutParentTemplateInput[];
  ...
  export type BudgetUpdateOneWithoutChildBudgetsNestedInput = {
    ...
    connect?: BudgetWhereUniqueInput;
    update?: XOR<
      XOR<BudgetUpdateToOneWithWhereWithoutChildBudgetsInput, BudgetUpdateWithoutChildBudgetsInput>,
      BudgetUncheckedUpdateWithoutChildBudgetsInput
    >;
  };
  ...
  export type BudgetUpdateManyWithoutParentTemplateNestedInput = {
    ...
    connectOrCreate?:
      ...
      | BudgetCreateOrConnectWithoutParentTemplateInput[];
    upsert?:
      | BudgetUpsertWithWhereUniqueWithoutParentTemplateInput
      | BudgetUpsertWithWhereUniqueWithoutParentTemplateInput[];
    createMany?: BudgetCreateManyParentTemplateInputEnvelope;
    set?: BudgetWhereUniqueInput | BudgetWhereUniqueInput[];
    disconnect?: BudgetWhereUniqueInput | BudgetWhereUniqueInput[];
    ...
    connect?: BudgetWhereUniqueInput | BudgetWhereUniqueInput[];
    update?:
      | BudgetUpdateWithWhereUniqueWithoutParentTemplateInput
      | BudgetUpdateWithWhereUniqueWithoutParentTemplateInput[];
    updateMany?:
      | BudgetUpdateManyWithWhereWithoutParentTemplateInput
      | BudgetUpdateManyWithWhereWithoutParentTemplateInput[];
    deleteMany?: BudgetScalarWhereInput | BudgetScalarWhereInput[];
  };
  ...
  export type BudgetUpsertWithoutChildBudgetsInput = {
    update: XOR<
      BudgetUpdateWithoutChildBudgetsInput,
      BudgetUncheckedUpdateWithoutChildBudgetsInput
    >;
    create: XOR<
      BudgetCreateWithoutChildBudgetsInput,
  ...
  export type BudgetUpsertWithWhereUniqueWithoutParentTemplateInput = {
    where: BudgetWhereUniqueInput;
    update: XOR<
      BudgetUpdateWithoutParentTemplateInput,
      BudgetUncheckedUpdateWithoutParentTemplateInput
    >;
    create: XOR<
      BudgetCreateWithoutParentTemplateInput,
      BudgetUncheckedCreateWithoutParentTemplateInput
